...
class Tradetracker extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tradetracker:transaction';
   ...
   ini_set('soap.wsdl_cache_enabled', 0);
        ...
        $credentials = array(
            'user' => Setting::get('settings.tradetracker_name'),
            'apipassword' => Setting::get('settings.tradetracker_pw')
        );
    ...
    {
        $commandName = 'tradetracker_transaction';
