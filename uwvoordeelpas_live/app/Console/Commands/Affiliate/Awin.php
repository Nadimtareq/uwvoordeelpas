...
class Awin extends Command
{
     ...
     * @var string
     */
    protected $signature = 'awin:affiliate';

    /**
     * @var string
     */
    protected $affiliate_network = 'awin';
    ...
    public function checkConnection() 
    {
        try {
            ...
            $this->client->setConnectId(Setting::get('settings.awin_name'));
            $this->client->setSecretKey(Setting::get('settings.awin_pw'));
            ...
            foreach ($feedCategory as $listCategories) {
                foreach ($listCategories as $listCategory) {
                    $this->parentsArray[$listCategory->id] = array(
                        'id' =>  $listCategory->id,
                        'name' => Lang::get('awin.'.str_slug($listCategory->_)),
                        'slug' => str_slug(Lang::get('awin.'.str_slug($listCategory->_)))
                    );
                }
            }
        }
