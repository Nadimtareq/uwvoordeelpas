...
<div id="sliderImage" class="slider{{ Request::is('admin/*') == TRUE ? ' admin' : '' }}" style="{{ Route::getCurrentRoute()->uri() == '/' && $userAuth == FALSE ? '' : 'background-color: #000000;' }}">
    ...
    @if(($userAuth == FALSE) OR  ($userAuth && $userInfo->extension_downloaded == 0)) 
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a id="install-button" style="margin-top: 80px; cursor:pointer; display: inline-block;" data-browser="{{$browser['name']}}" class="homepage_btn install {{$browser['name']}}">Ja! Ik wil gratis sparen!</a>
                        @endif
