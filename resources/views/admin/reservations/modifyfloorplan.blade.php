...
@section('content')
    ...
    <div class="content">
        ...
        <div class="clearfix btn-container">
            <div class="btn blue darken-4">Voeg plattegrond toe</div>
    ...
    <button onclick="prvs()" id="btnTwo"> previous</button>
        ...
        <div>
            ...
            $today = date("Y.m.d");
            ?>
            <div class="owl-carousel time-carousel">
                @foreach($time as $t)
                    <div class="time-container"><a href="{{url('admin/reservations/modifyfloorplan/'.$company.'/'.$today.'-'.$t)}}">{{$t }}</a></div>
                @endforeach
            </div>
        </div>
        ...
        <div>Iframe: {{url('embed-floorplan/'.$company)}}</div>
    </div>
    <div class="clear"></div>
    <script>
        ...
        $( document ).ready(function() {
            ...
            $(".time-carousel").owlCarousel({
                ...
                touchDrag : false
                    ...
                    $minutes += date("H") * 60;
                    ?>
            var active = {{ceil($minutes / 15)}};
            var timeCarousel = $(".time-carousel").data('owlCarousel');
            timeCarousel.jumpTo(active);
            $(".time-carousel .owl-item:nth-child("+active+") .time-container").addClass('active');
