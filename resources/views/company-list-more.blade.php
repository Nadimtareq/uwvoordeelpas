...
@foreach ($recommended as $data)
    ...
    <div class="company recommended hidden"
            ...
            <div title="{{ $data->name }}" class="computerImage">
                @if (isset($media[0]))
                    <a href="{{ url('restaurant/'.$data->slug) }}" title="{{ $data->name }}">
                        <img src="{{ url('public'.$media[0]->getUrl('175Thumb')) }}" alt="{{ $data->name }}"/>
                    </a>
                @else
                    <a href="{{ url('restaurant/'.$data->slug) }}" title="{{ $data->name }}">
                        <img src="{{ url('public/images/placeholdimage.png') }}" alt="{{ $data->name }}"/>
                    </a>
                @endif
        ...
        <div class="text">
            ...
            <div class="info">
                <a href="{{ url('search?q='.$data->city) }}"><span><i class="marker icon"></i> {{ $data->city }}
                        &nbsp;</span></a>
