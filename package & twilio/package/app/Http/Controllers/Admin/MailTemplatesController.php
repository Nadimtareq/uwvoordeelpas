...
public function send($slug = null)
    {
        $companyOwner = Company::isCompanyUserBySlug($slug, Sentinel::getUser()->id);
        ...
        if ($companyOwner['is_owner'] == TRUE) {
            ...
            return view('admin/'.$this->slugController.'/send', [
                'companies' => Company::lists('name', 'id'),
                'slugController' => $this->slugController,
                'section' => $this->section, 
                'currentPage' => 'Nieuw mail template'
    ...
    public function message($slug = null)
    {
        ...
        if ($companyOwner['is_owner'] == TRUE) {
            ...
            return view('admin/'.$this->slugController.'/message', [
                'companies' => Company::lists('name', 'id'),
                'slugController' => $this->slugController,
                'section' => $this->section, 
                'currentPage' => 'Nieuw mail template'
 ...
 public function createPackage($slug = null)
    {
        $companyOwner = Company::isCompanyUserBySlug($slug, Sentinel::getUser()->id);
        ...
        if ($companyOwner['is_owner'] == TRUE) {
            ...
            return view('admin/'.$this->slugController.'/createPackage', [
                'companies' => Company::lists('name', 'id'),
                'slugController' => $this->slugController,
                'section' => $this->section, 
                'currentPage' => 'Nieuw mail template'
    ...
    public function packageshow($slug = null)
    {
        $companyOwner = Company::isCompanyUserBySlug($slug, Sentinel::getUser()->id);
        ...
        if ($companyOwner['is_owner'] == TRUE) {
            ...
            return view('admin/'.$this->slugController.'/packageshow', [
                'companies' => Company::lists('name', 'id'),
                'slugController' => $this->slugController,
                'section' => $this->section, 
                'currentPage' => 'Nieuw mail template'
    ...
    public function assignPackage($slug = null)
    {
        $companyOwner = Company::isCompanyUserBySlug($slug, Sentinel::getUser()->id);
        ...
        if ($companyOwner['is_owner'] == TRUE) {
            ...
            return view('admin/'.$this->slugController.'/assignPackage', [
                'companies' => Company::lists('name', 'id'),
                'slugController' => $this->slugController,
                'section' => $this->section, 
                'currentPage' => 'Nieuw mail template'
    ...
    public function save(Request $request) 
    {
        ...
        $data = new packages;
            ...
            $data->category = $request->input('quantity');
            $data->explanation = $request->input('price');
            $data->company_id =  $request->input('total');
            $data->save();

            Alert::success('Dit mail template is succesvol aangepast.')->persistent('Sluiten');   
            return Redirect::to('admin/mailtemplates/createPackage/');
