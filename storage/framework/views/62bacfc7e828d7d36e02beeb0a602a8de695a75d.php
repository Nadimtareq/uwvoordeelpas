            ...
            <div class="col-sm-12 tabs-content">
                ...
                <div class="col-sm-4 col-xs-12 col4">
                    <a href="<?php echo e(url('search?regio='.$city->slug)); ?>">
                        <?php if(isset($media[0]) && $FileHelper::is_url_exist(url(''.$media[0]->getUrl('thumb')))): ?>

                        <img class="ui image" src="<?php echo e(url(''.$media[0]->getUrl('thumb'))); ?>" alt="<?php echo e($city->name); ?>">
                        <?php else: ?>
                        <img class="ui image" src="<?php echo e(url('images/placeholdimage.png')); ?>" alt="<?php echo e($city->name); ?>" data-url="<?php echo e(url(''.$media[0]->getUrl('thumb'))); ?>">
                        <?php endif; ?>
