        ...
        <?php if($data != ''): ?>
            ...
            <?php if(Request::has('step')): ?>
                <div class="ui three mini steps">
                    <a href="<?php echo e(url('admin/companies/update/'.$data->id.'/'.$data->slug.'?step=1')); ?>" class="link active step">
            ...
            <?php echo Form::open(array('url' => 'admin/reservations-options/update/'. $data->id.'/'.(trim($slug) != '' ? $slug : '').(Request::has('step') ? '?step=3' : ''),'method' => 'post', 'class' => 'ui edit-changes form', 'files' => TRUE)) ?>
            ...
            <div class="left section">
                ...
                <div class="three fields">
                    ...
                    <div class="field <?php echo e(Request::has('step') OR $userAdmin ? '' : 'disabled'); ?>">
                        <label>KVK</label>
                ...
                <?php if(Request::has('step')): ?>
                    ...
                    <div class="field">
                        <div class="ui checkbox">
                            ...
                            <label>Ik ga akkoord met de voorwaarden op <strong><?php echo e(date('d-m-Y H:i')); ?></strong> met IP adres <strong><?php echo e(Request::getClientIp()); ?></strong></label>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(url('restaurant/'.$data->slug)); ?>" target="_blank" class="ui tiny button"><i class="file icon"></i> Voorbeeld</a>
                <?php endif; ?>
            </div>
                            ...
                            <div class="ui one cards">
                                <?php foreach($documentItems as $id => $doc): ?>
                                    <div class="card">
                                        ...
                                        <div class="extra">
                                            <a href="<?php echo e(url('public/'.$doc->getUrl())); ?>" target="_blank"><i class="download icon"></i></a>
                                            <a href="<?php echo e(url('admin/'.$slugController.'/delete/image/'.$data->slug.'/'.$id.'?type=documents')); ?>"><i class="trash icon"></i></a>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        ...
                        <ol class="serialization">
                            <?php foreach($media as $id => $images): ?>
                                ...
                                <!-- <a href="<?php echo e(url('admin/'.$slugController.'/crop/image/'.$data->slug.'/'.$id.'?type=images')); ?>">
                                    ...
                                    <a href="<?php echo e(url('admin/'.$slugController.'/delete/image/'.$data->slug.'/'.$id.'?type=images')); ?>"><i class="trash icon"></i></a>
