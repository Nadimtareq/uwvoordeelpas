...
<ul id="slide-out" class="side-nav2 right-aligned" style="overflow:auto" >
    ...
    <?php if($userAuth): ?>
        ...
        <li><a href="<?php echo e(url('account')); ?>" ><i class="material-icons">code</i> Mijn gegevens</a></li>
        ...
        <li><a href="<?php echo e(url('reference_code')); ?>"><i class="material-icons">euro_symbol</i>Geld verdienen</a></li>
