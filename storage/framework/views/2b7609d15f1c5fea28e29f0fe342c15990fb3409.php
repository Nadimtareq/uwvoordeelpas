        ...
        <div class="two fields">
            ...
            <div class="field">
                <div id="personsField" class="ui normal compact selection dropdown persons searchReservation calendarInput">
                    <input type="hidden" name="persons" value="<?php echo e(($userAuth && $userInfo->kids != 'null' && $userInfo->kids != NULL && $userInfo->kids != '[""]' ? $userInfo->kids : 1)); ?>">
                    ...
                    <div class="menu">
                        <?php for($i = 1; $i <= 10; $i++): ?>
                            <div class="item" data-value="<?php echo e($i); ?>"><?php echo e($i); ?> <?php echo e($i == 1 ? 'persoon' : 'personen'); ?></div>
                        <?php endfor; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="two fields">
            <div class="field">
                <div id="timeField" class="ui normal compact selection dropdown time">
                    <input type="hidden" name="time" value="<?php echo e(count(array_keys($reservationTimesArray)) >= 1 ? array_keys($reservationTimesArray)[0] : ''); ?>">
                    <i class="time icon"></i>
            ...
            <a href="<?php echo URL::to('restaurant/'.$company->slug) ?>" target="_blank">
                <img src="<?php echo e(url('images/vplogo.png')); ?>" width="70%" />
            </a>
        </div>
        <?php echo Form::close(); ?>
    </div>
...
<script type="text/javascript" src="<?php echo e(asset('js/jquery-1.11.3.min.js?rand='.str_random(40))); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('js/app.js?rand='.str_random(40))); ?>"></script>
</body>
</html>
