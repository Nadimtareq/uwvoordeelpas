...
<div class="content">
    ...
    <div class="buttonToolbar">  
                    ...
                    <div class="four column row">
                        <div class="column">
                            <div class="ui normal icon search selection fluid dropdown">
                                ...
                                <div class="menu">
                                    <a class="item" href="<?php echo e(url('admin/giftcards?status=1')); ?>">Geactiveerd</a>
                                    <a class="item" href="<?php echo e(url('admin/giftcards?status=0')); ?>">Niet geactiveerd</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="ui normal icon search selection fluid dropdown">
                                ...
                                <div class="menu">
                                    <?php if(count($companies) >= 1): ?>
                                        ...
                                        <a class="item" href="<?php echo e(url('admin/giftcards?company=').$company->slug); ?>"><?php echo e($company->name); ?></a>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </div>
                            </div>
     ...
     <?php if($userAdmin): ?>
        <a href="<?php echo e(url('admin/giftcards/export')); ?>" class="ui icon button"><i class="download icon"></i> Exporteer</a>
        <a href="<?php echo e(url('admin/giftcards/import')); ?>" class="ui icon button"><i class="plus icon"></i> Importeer</a>
    <?php endif; ?>
