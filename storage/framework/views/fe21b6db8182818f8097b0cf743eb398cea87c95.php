        ...
        <div class="menu">
            <?php foreach($categories as $category): ?>
                ...
                <?php foreach($category['subcategories'] as $subcategory): ?>
                    <?php if($subcategory['name'] != NULL): ?>
                        <div class="item" data-value="<?php echo e($subcategory['id']); ?>">
...
<div class="content">
    ...
    <div class="buttonToolbar">  
        <div class="ui grid">
            ...
            <div class="row">
                <div class="left floated sixteen wide mobile eleven wide computer column">
                    <a href="<?php echo e(url('admin/categories')); ?>" class="ui icon button"> <i class="list icon"></i> Hoofdrubrieken</a>
                    <a href="<?php echo e(url('admin/subcategories')); ?>" class="ui icon button"><i class="ordered list icon"></i> Subrubrieken </a>
                </div>
                ...
                <div class="ui normal icon selection fluid dropdown">
                    ...
                    <div class="menu">
                        ...
                        <div class="scrolling menu">
                            <a class="item" 
                                href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array('network' => 'affilinet', 'limit' => Request::input('limit'))))); ?>" 
                                data-value="affilinet">
                                Affilinet
                            </a>

                            <a class="item" 
                               href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array('network' => 'familyblend', 'limit' => Request::input('limit'))))); ?>" 
                               data-value="familyblend">
                               FamilyBlend
                            </a>

                            <a class="item" 
                               href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array('network' => 'daisycon', 'limit' => Request::input('limit'))))); ?>" 
                               data-value="daisycon">
                               Daisycon
                            </a>

                            <a class="item" 
                               href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array('network' => 'tradedoubler', 'limit' => Request::input('limit'))))); ?>" 
                               data-value="tradedoubler">
                               Tradedoubler
                            </a>

                            <a class="item" 
                               href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array('network' => 'tradetracker', 'limit' => Request::input('limit'))))); ?>" 
                               data-value="tradetracker">
                               Tradetracker
                            </a>

                            <a class="item" 
                               href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array('network' => 'zanox', 'limit' => Request::input('limit'))))); ?>" 
                               data-value="zanox">
                               Zanox
                            </a>
                        </div>
