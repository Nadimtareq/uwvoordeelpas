...
<div class="extension-install-overlay" style="display: none;">
    <div class="extension-install-fade">
        <div class="text <?php echo e($browser['name']); ?>">
            <h3>Klik hier!</h3>
...
<div id="sliderImage" class="slider<?php echo e(Request::is('admin/*') == TRUE ? ' admin' : ''); ?>" >
                                ...
                                <?php if (($userAuth == FALSE) OR ( $userAuth && $userInfo->extension_downloaded == 0)): ?>
                                    ...
                                    <?php if(in_array($browser['name'], $compatible_browser_array)):?>
                                        <?php if ($userAuth == FALSE): ?>
                                            <button data-browser="<?php echo e($browser['name']); ?>" class="login button_action" data-type="login" data-redirect="<?php echo e(URL::full('/').'?extension_download_btn=1'); ?>">Ja ik wil ook sparen!</button>
                                        <?php elseif ($userAuth && $userInfo->extension_downloaded == 0): ?>
                                            <button data-browser="<?php echo e($browser['name']); ?>" id="header_extension_button" class="install-button-ext button_action">Ja ik wil ook sparen!</button>
                                        <?php endif; ?>
                                    <?php else:?>
                                            <button data-browser="<?php echo e($browser['name']); ?>" class="incompatible_browser_ext button_action">Ja ik wil ook sparen!</button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-6 col2">
                        <img src="<?php echo e(asset('images/laptop.png')); ?>" alt="laptop" class="laptop">
                        <div class="text">
                    ...
                    <div class="col-sm-6">
                        ...
                        <?php if(in_array($browser['name'], $compatible_browser_array)):?>
                            <?php if ($userAuth == FALSE): ?>
                                <button data-browser="<?php echo e($browser['name']); ?>" class="login button_action" data-type="login" data-redirect="<?php echo e(URL::full('/').'?extension_download_btn=1'); ?>">Ja ik wil ook sparen!</button>
                            <?php elseif ($userAuth && $userInfo->extension_downloaded == 0): ?>
                                <button data-browser="<?php echo e($browser['name']); ?>" id="section_extension_button" class="install-button-ext button_action">Ja ik wil ook sparen!</button>
                            <?php endif; ?>
                        <?php else:?>
                            <button data-browser="<?php echo e($browser['name']); ?>" class="incompatible_browser_ext button_action">Ja ik wil ook sparen!</button>
                        <?php endif;?>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-3 coll">
                        <a href="<?php echo e(url('tegoed-sparen')); ?>">
                            <img src="<?php echo e(url('images/how_it_works_1.png')); ?>"  alt="<?php echo e(isset($contentBlock[49]) ? strip_tags($contentBlock[49]) : '1. Shopt u ook online?'); ?>">
                            <?php echo isset($contentBlock[49]) ? $contentBlock[49] : '1. Shopt u ook online?'; ?>
                    ...
                    <div class="col-sm-3 coll">
                        <a href="<?php echo e(url('tegoed-sparen')); ?>">
                            <img src="<?php echo e(url('images/how_it_works_2.png')); ?>" alt="<?php echo e(isset($contentBlock[50]) ? strip_tags($contentBlock[50]) : '2. Spaar bij 1500+ Webshops!'); ?>">
                    ...
                    <div class="col-sm-3 coll">
                        <a href="<?php echo e(url('search')); ?>">
                            <img src="<?php echo e(url('images/how_it_works_3.png')); ?>" alt="<?php echo e(isset($contentBlock[51]) ? strip_tags($contentBlock[51]) : '3. Reserveer met uw spaartegoed!'); ?>">
                            <?php echo isset($contentBlock[51]) ? $contentBlock[51] : '3. Reserveer met uw spaartegoed!'; ?>
                    ...
                    <div class="col-sm-3 coll">
                        <a href="<?php echo e(url('tegoed-sparen')); ?>">
                            <img src="<?php echo e(url('images/how_it_works_4.png')); ?>" alt="<?php echo e(isset($contentBlock[52]) ? strip_tags($contentBlock[52]) : '4. Geniet van uw spaartegoed!'); ?>">
                            <?php echo isset($contentBlock[52]) ? $contentBlock[52] : '4. Geniet van uw spaartegoed!'; ?>
    ...
    <?php if((Route::getCurrentRoute()->uri() == '/' && $userAuth == true) OR (Route::getCurrentRoute()->uri() == '/' && $userAuth && $userInfo->extension_downloaded == 0)): ?>
    <!--
<div class="homepage_block_container">
    <div class="homepage_block_1">
            <a href="">
                    <img style=" width: auto; height: 315px;" src="<?php echo e(url('images/landingpage_notebook.jpeg')); ?>">
            </a>
    </div>
    ...
    <div class="homepage_block_2">
            ...
            <a  style="margin-top: 80px; display: inline-block;" class="homepage_btn install <?php echo e($browser['name']); ?>"
                    href="/firefox.xpi" iconURL="/images/icons/android-icon-48x48.png">Ja! Ik wil gratis sparen!</a>
            endif
            if(strtolower($browser['name']) == 'chrome')
            <a href="#" onclick="chromeInstallFunction();" id="install-button" style="margin-top: 80px; display: inline-block;" class="homepage_btn install <?php echo e($browser['name']); ?>">Ja! Ik wil gratis sparen!</a>
    endif
