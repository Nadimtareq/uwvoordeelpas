                ...
                <div class="ui grid">
                    <div class="five column row">
                        <div class="sixteen wide mobile four wide computer column">
                            <a href="<?php echo e(url('admin/'.$slugController.'/create')); ?>" class="ui icon blue button">
                            ...
                            <div class="ui normal icon selection fluid dropdown">
                                ...
                                <div class="menu">
                                    ...
                                    <div class="scrolling menu">
                                        <a class="item" 
                                           href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array_add($queryString, 'status', 'accepted')))); ?>" 
                                        ...
                                        <a class="item" 
                                           href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array_add($queryString, 'status', 'rejected')))); ?>" 
                        ...
                        <div class="sixteen wide mobile three wide computer column">
                            <div class="ui normal icon selection fluid dropdown">
                                ...
                                <div class="menu">
                                    ...
                                    <div class="scrolling menu">
                                        <a class="item" 
                                           href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array_add($queryString, 'network', 'affilinet')))); ?>" 
                                           data-value="affilinet">
                                            Affilinet
                                        </a>

                                        <a class="item" 
                                           href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array_add($queryString, 'network', 'daisycon')))); ?>" 
                                           data-value="daisycon">
                                            Daisycon
                                        </a>

                                        <a class="item" 
                                           href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array_add($queryString, 'network', 'tradedoubler')))); ?>" 
                                           data-value="tradedoubler">
                                            Tradedoubler
                                        </a>

                                        <a class="item" 
                                           href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array_add($queryString, 'network', 'tradetracker')))); ?>" 
                                           data-value="tradetracker">
                                            Tradetracker
                                        </a>

                                        <a class="item" 
                                           href="<?php echo e(url('admin/'.$slugController.'?'.http_build_query(array_add($queryString, 'network', 'zanox')))); ?>" 
                                           data-value="zanox">
                                            Zanox
                                        </a>
                                    </div>
                        ...
                        <div class="sixteen wide mobile two wide computer column">
                            <div class="ui normal icon selection fluid dropdown">
                                ...
                                <div class="menu">
                                    <a href="<?php echo e(url('admin/transactions?'.http_build_query(array_add($queryString, 'source', 'seatme')))); ?>" data-value="seatme" class="item">SeatMe</a>
                                    <a href="<?php echo e(url('admin/transactions?'.http_build_query(array_add($queryString, 'source', 'eetnu')))); ?>" data-value="eetnu" class="item">EetNU</a>
                                    <a href="<?php echo e(url('admin/transactions?'.http_build_query(array_add($queryString, 'source', 'couverts')))); ?>" data-value="couverts" class="item">Couverts</a>
                                    <a href="<?php echo e(url('admin/transactions?'.http_build_query(array_add($queryString, 'source', 'wifi')))); ?>" data-value="wifi" class="item">Wi-Fi</a>
                                </div>
                            </div>
                        </div>
            ...
            <tr>
                <td>
                    <div class="ui child checkbox">
                        <input type="checkbox" name="id[]" value="<?php echo e($transaction->id); ?>">
                        <label></label>
                    </div>
                </td>
                <td><?php echo e(date('d-m-Y', strtotime($transaction->created_at))); ?></td>
                <td>
                    <a href="<?php echo e(url('admin/transactions?shop='.strtolower($transaction->programSlug))); ?>">
                        <?php echo e($transaction->programName); ?>

                    </a>
                </td>
                <td>&euro; <?php echo e($transaction->amount); ?></td>
                <td>
                    <?php if(trim($transaction->name) != ''): ?>
                    <a href="<?php echo e(url('admin/users/update/'.$transaction->user_id)); ?>">
                ...
                <td>
                    <a href="<?php echo e(url('admin/transactions?network='.strtolower($transaction->affiliate_network))); ?>">
                        <?php echo e($transaction->affiliate_network); ?>

                    </a>
                </td>
                <td>
                    <?php if($transaction->status == 'accepted'): ?>
                ...
                <td><?php echo e($transaction->getExpiredDate()); ?></td>

                <td>
                    <a href="<?php echo e(url('admin/'.$slugController.'/update/'.$transaction->id)); ?>" class="ui icon tiny button">
