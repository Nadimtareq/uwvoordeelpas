<?php $preferenceCity = app('App\Models\Preference'); ?>
...
<div class="default">
	...
	<div class="field">
		<div class="ui checkbox">
			...
			<label>Ik ga akkoord met de <a href="<?php echo e(url('algemene-voorwaarden')); ?>" target="_blank">algemene voorwaarden</a></label>
		</div>
	</div>
