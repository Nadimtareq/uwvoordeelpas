							...
							<nav class="primary-nav">
								...
								<div class="clearfix nav-wrapper">
									...
									<a href="<?php echo e(url('/')); ?>" class="brand-logo">
										<!--<div style="background-image=url(<?php echo e(asset('images/logo.png')); ?>)" class="responsive-img">-->
										<img src="<?php echo e((($isGrey) ) ? asset('images/logo_grey.png') : asset('images/logo.png')); ?>" alt="" class="responsive-img">
									</a>
									<!--
									<a href="<?php echo e(url('/')); ?>" class="left brand-logo menu-smooth-scroll pp-container" data-section="#home">
									...
									<ul class="inline-menu side-nav" id="mobile-demo">
										...
										<?php endif; ?> 
										<li>
										  <a href="#" class="question">Help <div class="question2"><img src="<?php echo e(asset('images/question.png')); ?>" alt="question"></div> <i class="fa fa-question-circle-o" aria-hidden="true"></i></a>
										</li>
										<li>
