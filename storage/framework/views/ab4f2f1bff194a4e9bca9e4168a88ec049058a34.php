    ...
    <table class="ui very basic sortable collapsing celled table list" style="width: 100%;">
        ...
        <tbody class="list">
            ...
            <tr>
                ...
                <td><p style="display:none;font-size:12px;" onmouseout="$(this).parent().find('span').show();$(this).hide();"><?php echo e($result->phone); ?></p><span style="font-size:12px;" onmouseover="$(this).parent().find('p').show();$(this).hide();"><?php echo e(substr($result->phone,0,10)); ?></span></td>
