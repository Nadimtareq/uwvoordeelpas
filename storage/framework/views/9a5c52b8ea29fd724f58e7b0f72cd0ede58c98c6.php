 <?php if($userAdmin): ?>
    ...
    <li><a href="<?php echo e(url('admin/barcodes')); ?>" ><i class="material-icons notranslate">line_weight</i> Barcodes</a></li>
    <li><a href="<?php echo e(url('admin/giftcards')); ?>" ><i class="material-icons notranslate">card_membership</i> Giftcards</a></li>
