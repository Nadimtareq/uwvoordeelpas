            ...
            <div class="field">
                <div class="ui normal floating dropdown labeled icon fluid button">
                    ...
                    <div class="menu">
                         ...
                         <a class="item" href="<?php echo e(url('account/reservations/saldo?'.http_build_query(array_add($queryString, 'type', 'payments')))); ?>">Giftcard gekocht</a>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                ...
                                <?php elseif($fetch['status'] == "received"): ?>
                                    Ontvangen
                                <?php elseif($fetch['status'] == "cancelled"): ?>
                                    Geannuleerd
                                <?php else: ?>
                                    In behandeling
                                <?php endif; ?>
