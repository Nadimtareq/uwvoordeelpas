...
<html>
<head>
  <title>Factuur <?php echo e($invoiceNumber); ?></title>
...
<body>
    <table style="width: 100%;">
        <tbody>
            <tr>
                <td style="width: 500px;"><img src="<?php echo e(base_path().'/public/images/logo.png'); ?>" width="150" /></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="detail" style="margin: 0px; border-top: none;">
        <tr>
            ...
            <td class="field"><?php echo e($company['name']); ?></td>
            <td class="label">Factuurnummer:</td>
            <td class="field"><?php echo e($invoiceNumber); ?></td>
        </tr>
        <tr>
            <td class="label"></td>
            <td class="field"><?php echo e($company['address']); ?></td>
            <td class="label">Factuurdatum:</td>
            <td class="field"><?php echo e(date('d-m-Y', strtotime($invoiceDate['startDate']))); ?></td>
        </tr>
        <tr>
            <td class="label"></td>
            <td class="field"><?php echo e($company['zipcode']); ?> <?php echo e($company['city']); ?></td>
            <td class="label">Verloopdatum:</td>
            <td class="field"><?php echo e(date('d-m-Y', strtotime($invoiceDate['expireDate']))); ?></td>
        </tr>
        <tr>
            <td class="label">IBAN</td>
            <td class="field"><?php echo e($company['financial_iban']); ?> t.n.v. <?php echo e($company['financial_iban_tnv']); ?></td>
        </tr>
        <tr>
            <td class="label">BTW</td>
            <td class="field"><?php echo e($company['btw']); ?></td>
        </tr>
        <tr>
            <td class="label">KVK</td>
            <td class="field"><?php echo e($company['kvk']); ?></td>
        </tr>
    </table>
    ...
    <?php if($type == 'products'): ?>
        ...
        <table class="list" style="width: 99%; margin-top: 1em;">
            ...
            <?php foreach($products as $product): ?>
                ...
                ?>
                <?php if(isset($product->description) && isset($product->price) && trim($product->price) != ''): ?>
                <tr class="list_row">
                    ...
                    <td>&euro;<?php echo e($company['debit_credit'] == 'credit' ? '-' : ''); ?><?php echo e($product->price); ?></td>
                    <?php endif; ?>

                    <?php if(isset($product->tax)): ?>
                    <td><?php echo e($product->tax); ?>%</td>
                    <?php endif; ?>
                    <?php if(isset($product->amount, $product->price, $product->tax)): ?>
                    <td>&euro;<?php echo e(($product->amount * $product->price * $product->tax) / 100); ?></td>
                    <?php endif; ?>
                    
                    <?php if(isset($product->amount, $product->price, $product->tax)): ?>
                    <td>&euro;<?php echo e($company['debit_credit']  == 'credit' ? '-' : ''); ?><?php echo e($product->amount * $product->price * ($product->tax / 100 + 1)); ?></td>
                    <?php endif; ?>
                </tr>
                <?php endif; ?>
            <?php endforeach; ?>
        ...
        <table class="list" style="width: 99%; margin-top: 1em;">
            <tr class="list_row">
                ...
                <td style="width: 20%">&euro;<?php echo e($company['debit_credit']  == 'credit' ? '-' : ''); ?><?php echo e(number_format($totalPriceExTax, 2, ',', ' ')); ?></td>
            </tr>

            <tr class="list_row">
                <td style="width: 70%"></td>
                <td style="width: 20%"><strong>Totaal btw</strong></td>                
                <td style="width: 20%">&euro;<?php echo e(number_format($totalTax, 2, ',', ' ')); ?></td>
            </tr>

            <tr class="list_row">
                <td style="width: 70%"></td>
                <td style="width: 20%"><strong>Totaal incl btw</strong></td>
                <td style="width: 20%">&euro;<?php echo e($company['debit_credit']  == 'credit' ? '-' : ''); ?><?php echo e(number_format($totalPrice, 2, ',', ' ')); ?></td>
            </tr>
        </table>
    <?php elseif($type == 'reservation'): ?>
        <table class="list" style="width: 99%; margin-top: 1em;">
            <tr class="head">
              ...
              <tr class="list_row red" style="color: red;">
                  <td><?php echo e($totalPersons); ?> gasten x €1.00 excl 21% per gast</td>
                  <td><?php echo e($totalPersons); ?></td>
                  <td>&euro;1,00</td>
                  <td>21%</td>
                  <td>&euro;<?php echo e(number_format(($totalPersons * 1 * 1.21), 2, ',', ' ')); ?></td>
              </tr>
        </table>
        ...
        <table class="list" style="width: 99%; margin-top: 1em;">
            <tr class="head">
              ...
              <tr class="list_row red" style="color: green;">
                  ...
                  <td>&euro;<?php echo e(number_format($totalSaldo, 2, ',', ' ')); ?></td>
              </tr>
        </table>
    <?php endif; ?>
    <br />
