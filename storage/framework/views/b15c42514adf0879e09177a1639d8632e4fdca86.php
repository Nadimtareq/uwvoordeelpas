      ...
      <tr>
       <td>
        <table class="full-width" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" width="150" cellspacing="0" cellpadding="0" align="left">
			<tbody>
			 <tr>
			  <td width="24" align="center"><img src="<?php echo e(asset('images/logo.png')); ?>" style="margin-top:5px;" alt="Logo"></td>
			 </tr>
			</tbody>
		</table>
        ...
        <table class="full-width" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" width="150" cellspacing="0" cellpadding="0" align="right">
			<tbody>
			 <tr>
			  <td align="left">
				<a href="<?php echo e(url('auth/set/'.$user['saldo_url'])); ?>" style="color: #fff; font-family: 'Poppins', sans-serif; font-size:16px; margin-top:12px;float:left;text-decoration:none;"><strong>Saldo €<?php echo e($user["saldo"]); ?></strong></a>
			  </td>
			 </tr>
			</tbody>
		</table>
    ...
    <td bgcolor="#fff" align="center">
     <table class="table-container" border="0" width="780" cellspacing="0" cellpadding="0">
      <tbody>
			...
			<!-- extension part  -->
<?php if($user["extension_downloaded"]==0): ?>
	<tr style="margin-top:20px;float:left;" align="left">
		 <td>
			...
			<tbody>
			<tr>
			 <td align="left" style="position: relative;text-align: center;"><img width="340" src="<?php echo e(asset('images/laptop-text.png')); ?>" alt='laptop' />
			 </td>
			</tr>
			 </tbody>
		 </table>
		...
		<tr>
					...
					<tr>
					 <td>
						<table align="left">
						 <tbody><tr>
							<td><a style="font-family: 'Poppins', sans-serif; font-size: 16px;background:#283593;padding:10px 26px ;border-radius:5px; font-weight: normal; color: #fff;" href="<?php echo e(url('auth/set/'.$user['extension_download_url'])); ?>">Ja ik wil ook sparen!</a></td>
						 </tr>
						</tbody></table>
					 </td>
					</tr>
  ...
  <table data-module="module-08" class="table800" style="width:800px;max-width:800px;" border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
   <tbody><tr>
    <td bgcolor="#fbfbfb" align="center">
     <table class="table-container" border="0" width="780" cellspacing="0" cellpadding="0">
      <tbody>
			<?php foreach($deals as $key => $restaurant): ?>
			<?php $i=0; ?>
				<?php foreach($restaurant as $deal): ?>
				<?php
		       ...
		       <td>
		        <table class="full-width" width="385" align="left">
		         <tbody><tr>
		          <td><a href="<?php echo e(url('auth/set/'.$deal['deal_url'])); ?>"><img  width="100%" height="264.13px" class="img-full" src="<?php echo e(asset('images/deals/'.$image)); ?>" alt="<?php echo e($deal['name']); ?>"></a></td>
		         </tr>
		         <tr>
		          <td height="20"></td>
		         </tr>
		         <tr>
		          <td align="left">
		           <table align="left">
		            <tbody><tr>
		             <td style="font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: 500; color: #121619;" align="left"><?php echo e($deal['name']); ?></td>
		            </tr>
		           </tbody></table>
		           <table align="right">
		            <tbody><tr>
		             <td></td>
		             <td width="5"></td>
		             <td style="font-family: 'Poppins', sans-serif; font-size:14px; font-weight:700; color:#283593;"><a href="<?php echo e(url('auth/set/'.$deal['deal_url'])); ?>"><strike><small style="color:gray;">€<?php echo e($deal['price_from']); ?></small></strike> &nbsp; <big>€<?php echo e($deal['price']); ?></big></a></td>
		            </tr>
		           </tbody></table>
		          </td>
		         </tr>
		        ...
		        <table class="full-width" width="385" align="right">
		         <tbody><tr>
		          <td><a href="<?php echo e(url('auth/set/'.$deal['deal_url'])); ?>"><img class="img-full" width="100%" height="264.13px" src="<?php echo e(asset('images/deals/'.$image)); ?>" alt="<?php echo e($deal['name']); ?>"></a></td>
		         </tr>
		         <tr>
		          <td height="20"></td>
		         </tr>
            ...
            <tbody><tr>
             <td>
              <table style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0" align="right">
               <tbody><tr>
                <td><a href="<?php echo e(url('auth/set/'.$user['unsubscribe_url'])); ?>" style="color: #283593; font-family: 'Poppins', sans-serif; font-size: 12px; font-weight: 400; text-decoration: none;">Unsubscribe</a></td>
               </tr>
              </tbody></table>
             </td>
            </tr>
