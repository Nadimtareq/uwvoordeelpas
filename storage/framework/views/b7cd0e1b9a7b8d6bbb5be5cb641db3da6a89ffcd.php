                        ...
                        <div class="col-sm-12">
                            <div class="home-inner">
                                <div class="center-align home-content">
                                    ...
                                    <button data-browser="<?php echo e($browser['name']); ?>"
                                            class="detectbrowser login button_action" data-type="login"
                                            data-redirect="<?php echo e(URL::full('/').'?extension_download_btn=1'); ?>">Ja ik wil
                                        ook sparen!
                                    </button>
                                    <?php elseif ($userAuth && $userInfo->extension_downloaded == 0): ?>
                                    <button data-browser="<?php echo e($browser['name']); ?>" id="header_extension_button"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-6 col2">
                            <img src="<?php echo e(asset('images/laptop-text.png')); ?>" alt="laptop" class="laptop">
                        </div>
                        <div class="col-sm-6">
                            ...
                            <?php if(in_array($browser['name'], $compatible_browser_array)):?>
                            <?php if ($userAuth == FALSE): ?>
                            <button data-browser="<?php echo e($browser['name']); ?>" class="login button_action detectbrowser"
                                    data-type="login" data-redirect="<?php echo e(URL::full('/').'?extension_download_btn=1'); ?>">
                                Ja ik wil ook sparen!
                            </button>
                            <?php elseif ($userAuth && $userInfo->extension_downloaded == 0): ?>
                            <button data-browser="<?php echo e($browser['name']); ?>" id="section_extension_button"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3 coll">
                            <a href="<?php echo e(url('tegoed-sparen')); ?>">
                                <img src="<?php echo e(url('images/how_it_works_1.png')); ?>"
                                     alt="<?php echo e(isset($contentBlock[49]) ? strip_tags($contentBlock[49]) : '1. Shopt u ook online?'); ?>">
                        ...
                        <div class="col-sm-3 coll">
                            <a href="<?php echo e(url('search')); ?>">
                                <img src="<?php echo e(url('images/how_it_works_3.png')); ?>"
                                     alt="<?php echo e(isset($contentBlock[51]) ? strip_tags($contentBlock[51]) : '3. Reserveer met uw spaartegoed!'); ?>">
                        ...
                        <div class="col-sm-3 coll">
                            <a href="<?php echo e(url('tegoed-sparen')); ?>">
                                <img src="<?php echo e(url('images/how_it_works_4.png')); ?>"
                                     alt="<?php echo e(isset($contentBlock[52]) ? strip_tags($contentBlock[52]) : '4. Geniet van uw spaartegoed!'); ?>">
